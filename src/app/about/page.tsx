      ...
      <Flex fillWidth s={{ direction: "column" }} horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          >
            ...
            <Flex className={styles.blockAlign} paddingTop="20" paddingBottom="8" gap="4" wrap horizontal="center" vertical="center" fitWidth>
              <Icon onBackground="success-weak" name="globe" />{person.location}&nbsp;&nbsp;&nbsp;&nbsp;
              <Icon onBackground="accent-weak" name="birthday" />{person.birth}
            </Flex>
            {social.length > 0 && (
